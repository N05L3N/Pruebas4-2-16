...
# Informacion de la tabla de Comentarios para buscar el estado de la venta y la fecha proxima
	...
	$result_ecrm_comentarios_s1 = mysql_query("SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario_vendedor' AND id_seguimiento = '$asignacion_vendedor' ORDER BY id_comentarios_s desc limit 0,1");
...
<div class="btn-group btn-group-xs">
	...
	<?php
		if ($row_result_ecrm_comentarios_s1['estadodeventa'] == 'Caliente') {
...
<div style="<?= $style ?>">
	<?php include('m.panel.vendedor.td5.1.php') ?>
</div>
