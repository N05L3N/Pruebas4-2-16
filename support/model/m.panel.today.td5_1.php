...
<?php
  ...
  $result3 = mysql_query("SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario_vendedor' AND id_seguimiento = '$asignacion_vendedor' ORDER BY id_comentarios_s desc limit 0,100");
