...
/* FILTRO POR FILTROS */
	...
	#$sql_pendientes = "SELECT * FROM ecrm_comentarios_s WHERE fechaproxima < '$fecha_pendientes' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal' ORDER By usuario";
	$sql_pendientes = "SELECT * FROM jcnoble.ecrm_comentarios_s WHERE horaasignacion != 'ok' AND horaasignacion != 'oktemporal' ORDER BY usuario desc limit 0,999999";
