...
<table class="table table-condensed">
	<caption>
		<b><a href="cliente.php?id=<?= $busca ?>&vendedor=<?= $_SESSION['vendedor'] ?>">Comentarioas:</a></b><br />
	</caption>

<?php
	
	$result3 = mysql_query("SELECT * FROM ecrm_comentarios_s WHERE id_seguimiento = '$asignacion_vendedor' ORDER BY id_comentarios_s desc limit 0,100");
