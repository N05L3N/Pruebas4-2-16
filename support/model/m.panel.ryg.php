...
# Informacion de la tabla de Comentarios para buscar el estado de la venta y la fecha proxima
  ...
  $result_ecrm_comentarios_s1 = mysql_query("SELECT * FROM ecrm_comentarios_sryg WHERE id_seguimiento = '$idedit2' ORDER BY id_comentarios_sryg desc limit 0,1");
...
<?php
$result3 = mysql_query("SELECT * FROM ecrm_comentarios_sryg WHERE id_seguimiento = '$idedit2' ORDER BY id_comentarios_sryg desc limit 0,100");
