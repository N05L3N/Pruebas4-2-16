...
if (isset($_POST["usuario"])) {
	...
	$sql = "UPDATE `crmk`.`contacto` SET `asignadoa`='$asignadoa', `fechaasignacion`='$fechaasignacion' WHERE `id`='$id_seguimiento';";
		...
		*/
		...
		$m_sql = "INSERT INTO ecrm_comentarios_s (id_comentarios_s,id_seguimiento,usuario,termometro,estadodeventa,comentariovendedor,factura,fechaasignacion,horaasignacion,fecharespuesta,horarespuesta,fechaproxima)";
    		$m_sql.= "VALUES ('".$m_id_comentarios_s."','".$m_id_seguimiento."','".$m_usuario."','".$m_termometro."','".$m_estadodeventa."','".$m_comentariovendedor."','".$m_factura."','".$m_fechaasignacion."','".$m_horaasignacion."','".$m_fecharespuesta."','".$m_horarespuesta."','".$m_fechaproxima."')";
    		/*
			"Termina"
    		*/
