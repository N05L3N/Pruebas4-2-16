...
<?php
  ...
  $result = mysql_query("SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-03-08' ORDER BY id_comentarios_s desc limit $start,$per_page");
