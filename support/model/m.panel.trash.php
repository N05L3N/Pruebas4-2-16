...
<?php
  ...
  $result = mysql_query("SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND estadodeventa = 'descartado' AND horaasignacion != 'ok' AND fechaasignacion >= '2014-08-28' ORDER BY id_comentarios_s desc limit $start,$per_page");
