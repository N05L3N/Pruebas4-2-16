<tr>
  <td colspan="4">
<?php
$result_porfiltrodefecha = mysql_query("SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima >= '$fecha_inicio_filtro' AND fechaproxima <= '$fecha_fin_filtro' ORDER BY id_comentarios_s desc");
