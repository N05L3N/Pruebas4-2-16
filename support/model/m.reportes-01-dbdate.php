...
<table border='0' cellpadding='0'cellspacing='0' width='1024' style='font-size:12px;'>
	<tr>
...
*/
	...
	$result111 = mysql_query("SELECT * FROM crmk.ecrm_seguimiento_tipo WHERE id_seguimiento = '$busca'  AND tipo = 'No contesto' ORDER BY fecha desc limit 0,999");
	$i111 = 0;
...
#$result2 = mysql_query("SELECT * FROM crmk.ecrm_comentarios_s WHERE id_seguimiento = '$busca' ORDER BY id_seguimiento desc limit 0,1");
$result2 = mysql_query("SELECT * FROM crmk.ecrm_comentarios_s WHERE id_seguimiento = '$busca' ORDER BY fechaproxima desc limit 0,999");
	$i2 = 0;
