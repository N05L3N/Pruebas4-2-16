    ...
    while ($row_result_ecrm_comentarios_s1 = mysql_fetch_array($result_ecrm_comentarios_s1))
      {
        if ($i_result_ecrm_comentarios_s1 > 0)
          { }
            ...
            if ($row_result_ecrm_comentarios_s1['estadodeventa'] == 'frio') {
              ?>
              <span class="label label-info"><?= $row_result_ecrm_comentarios_s1['estadodeventa'] ?></span>
              <?php
            }

            else if ($row_result_ecrm_comentarios_s1['estadodeventa'] == 'descartado') {
             ?>
              <span class="label label-warning"><?= $row_result_ecrm_comentarios_s1['estadodeventa'] ?></span>
              <?php 
            }

            else {
              ?>
              <span class="label label-default"><?= $row_result_ecrm_comentarios_s1['estadodeventa'] ?></span>
              <?php 
            }
