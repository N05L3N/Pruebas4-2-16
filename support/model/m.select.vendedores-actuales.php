<?php
	...
	while ($row_vendedores_actuales = mysql_fetch_array($result_vendedores_actuales_filtro)) {
		if ($i_vendedores_actuales > 0) {
			...
			if ($row_vendedores_actuales['usuario'] == 'atpdis' OR $row_vendedores_actuales['usuario'] == 'areynoso' OR $row_vendedores_actuales['usuario'] == 'amariscal' OR $row_vendedores_actuales['usuario'] == 'gaguirre' OR $row_vendedores_actuales['usuario'] == 'irodriguez' OR $row_vendedores_actuales['usuario'] == 'eurrutia') {
