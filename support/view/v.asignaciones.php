...
<ul class="nav nav-tabs" role="tablist" style="width:75%; margin:auto;">
	...
	<li>
		<a href="#filtros2" role="tab" data-toggle="tab">
			Reporte de Actividad
		</a>
	</li>
	<li>
		<a href="#filtros3" role="tab" data-toggle="tab">
			Vencimientos
		</a>
	</li>
...
<div class="tab-content" style="width:75%; margin:auto;">
	...
	<div class="tab-pane" id="profile">
  	...
  	<div class="tab-pane" id="filtros2">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-md-8">
						<!-- FORM 2 -->
						<?php include('view/v.historial-reporte-de-actividad.phtml') ?>
					</div>
				</div>
			</div>
		</div>
  	...
  	<div class="tab-pane" id="filtros3">
		<div class="panel panel-default">
			<div class="panel-heading"></div>
			<div class="panel-body">
				<div class="row">
					<div class="col-md-12">
						<iframe src="vencimientos" name="segundo" width="100%" height="500" frameborder="0" scrolling="no"></iframe>
					</div>
				</div>
			</div>
		</div>
	...
	<table class="table table-condensed" style="width:75%; margin:auto;">
		<caption>
			<ul class="nav nav-tabs ">
				<li role="presentation" class="<?= $classTab1 ?>">
					<a href="?b=1">
						<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span> Mis asignaciones
					</a>
				</li>
				<li role="presentation" class="<?= $classTab2 ?>">
					<a href="?b=2">
						<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span> Facturados
					</a>
				</li>
			</ul>
		</caption>
