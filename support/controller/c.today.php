...
# DEFAULT
  ...
  $result = mysql_query("SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '$fecha_actual' AND horaasignacion != 'ok' ORDER BY fechaproxima desc limit 1000");
...
while ($row = mysql_fetch_array($result)) {
      ...
      $result = mysql_query("SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '$fecha_actual' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal' AND estadodeventa != 'descartado' ORDER BY id_comentarios_s desc limit 1000");
      # SELECT * FROM ecrm_comentarios_s WHERE usuario = 'sdelacruz' AND fechaproxima = '2015-02-27' AND horaasignacion != 'oktemporal' AND estadodeventa != 'descartado' ORDER BY id_comentarios_s desc limit 1000
      # SELECT * FROM ecrm_comentarios_s WHERE usuario = 'sdelacruz' AND fechaproxima = '2015-02-27' AND horaasignacion != 'ok' ORDER BY id_comentarios_s desc
      $i = 0;
      while ($row = mysql_fetch_array($result)) {
        if ($i > 0) {}
            $id_seguimiento= $row['id_seguimiento'];
