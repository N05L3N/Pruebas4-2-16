...
# Febrero del 2015
  ...
  $sql_fecha_asignaciones_01 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-01' AND horaasignacion != 'ok' ";
  ...
  if ($numero_fecha_asignaciones_01 == 0) {
    ...
    $sql_fecha_asignaciones_02 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-02' AND horaasignacion != 'ok' ";
  ...
  if ($numero_fecha_asignaciones_02 == 0) {
    ...
    $sql_fecha_asignaciones_03 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-03' AND horaasignacion != 'ok' ";
  ...
  if ($numero_fecha_asignaciones_03 == 0) {
    ...
    $sql_fecha_asignaciones_04 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-04' AND horaasignacion != 'ok' ";
  ...
  if ($numero_fecha_asignaciones_04 == 0) {
    ...
    $sql_fecha_asignaciones_05 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-05' AND horaasignacion != 'ok' ";
  ...
  if ($numero_fecha_asignaciones_05 == 0) {
    ...
    $sql_fecha_asignaciones_06 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-06' AND horaasignacion != 'ok' ";
  ...
  if ($numero_fecha_asignaciones_06 == 0) {
    ...
    $sql_fecha_asignaciones_07 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-07' AND horaasignacion != 'ok' ";
    ...
    $sql_fecha_asignaciones_08 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-08' AND horaasignacion != 'ok' ";
  ...
  if ($numero_fecha_asignaciones_08 == 0) {
    ...
    $sql_fecha_asignaciones_09 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-09' AND horaasignacion != 'ok' ";
  ...
  if ($numero_fecha_asignaciones_09 == 0) {
    ...
    $sql_fecha_asignaciones_10 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-10' AND horaasignacion != 'ok' ";
  ...
  if ($numero_fecha_asignaciones_10 == 0) {
    ...
    $sql_fecha_asignaciones_11 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-11' AND horaasignacion != 'ok' ";
  ...
  if ($numero_fecha_asignaciones_11 == 0) {
    ...
    $sql_fecha_asignaciones_12 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-12' AND horaasignacion != 'ok' ";
  ...
  if ($numero_fecha_asignaciones_12 == 0) {
    ...
    $sql_fecha_asignaciones_13 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-13' AND horaasignacion != 'ok' ";
  ...
  if ($numero_fecha_asignaciones_13 == 0) {
    ...
    $sql_fecha_asignaciones_14 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-14' AND horaasignacion != 'ok' ";
    ...
    $sql_fecha_asignaciones_15 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-15' AND horaasignacion != 'ok' ";
    ...
    $sql_fecha_asignaciones_16 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-16' AND horaasignacion != 'ok' ";
    ...
    $sql_fecha_asignaciones_17 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-17' AND horaasignacion != 'ok' ";
    ...
    $sql_fecha_asignaciones_18 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-18' AND horaasignacion != 'ok' ";
    ...
    $sql_fecha_asignaciones_19 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-19' AND horaasignacion != 'ok' ";
    ...
    $sql_fecha_asignaciones_20 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-20' AND horaasignacion != 'ok' ";
    ...
    $sql_fecha_asignaciones_21 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-21' AND horaasignacion != 'ok' ";
    ...
    $sql_fecha_asignaciones_22 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-22' AND horaasignacion != 'ok' ";
    ...
    $sql_fecha_asignaciones_23 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-23' AND horaasignacion != 'ok' ";
    ...
    $sql_fecha_asignaciones_24 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-24' AND horaasignacion != 'ok' ";
    ...
    $sql_fecha_asignaciones_25 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-25' AND horaasignacion != 'ok' ";
    ...
    $sql_fecha_asignaciones_26 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-26' AND horaasignacion != 'ok' ";
    ...
    $sql_fecha_asignaciones_27 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-27' AND horaasignacion != 'ok' ";
    ...
    $sql_fecha_asignaciones_28 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-28' AND horaasignacion != 'ok' ";
    ...
    $sql_fecha_asignaciones_29 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-29' AND horaasignacion != 'ok' ";
    ...
    $sql_fecha_asignaciones_30 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-30' AND horaasignacion != 'ok' ";
    ...
    if ($numero_fecha_asignaciones_30 == 0) {
      ...
      $color_fecha_asignaciones_30 = 'd70098';
        ...
        $sql_fecha_asignaciones_31 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2015-02-31' AND horaasignacion != 'ok' ";
