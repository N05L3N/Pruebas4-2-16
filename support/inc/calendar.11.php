...
# Noviembre del 2014
  ...
  $sql_fecha_asignaciones_01 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-01' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_01 == 0) {
    ...
    $sql_fecha_asignaciones_02 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-02' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_02 == 0) {
    ...
    $sql_fecha_asignaciones_03 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-03' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_03 == 0) {
    ...
    $sql_fecha_asignaciones_04 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-04' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_04 == 0) {
    ...
    $sql_fecha_asignaciones_05 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-05' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_05 == 0) {
    ...
    $sql_fecha_asignaciones_06 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-06' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_06 == 0) {
    ...
    $sql_fecha_asignaciones_07 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-07' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_08 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-08' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_08 == 0) {
    ...
    $sql_fecha_asignaciones_09 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-09' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_09 == 0) {
    ...
    $sql_fecha_asignaciones_10 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-10' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_10 == 0) {
    ...
    $sql_fecha_asignaciones_11 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-11' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_11 == 0) {
    ...
    $sql_fecha_asignaciones_12 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-12' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_12 == 0) {
    ...
    $sql_fecha_asignaciones_13 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-13' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_13 == 0) {
    ...
    $sql_fecha_asignaciones_14 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-14' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_15 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-15' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_16 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-16' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_17 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-17' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_18 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-18' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_19 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-19' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_20 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-20' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_21 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-21' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_22 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-22' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_23 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-23' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_24 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-24' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_25 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-25' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_26 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-26' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_27 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-27' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_28 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-28' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_29 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-29' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_30 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-30' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    if ($numero_fecha_asignaciones_30 == 0) {
      ...
      $color_fecha_asignaciones_30 = 'd70098';
        ...
        $sql_fecha_asignaciones_31 = "SELECT * FROM ecrm_comentarios_s WHERE usuario = '$usuario' AND fechaproxima = '2014-11-31' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
