...
alert("El campo: \" Próxima llamada\" es obligatorio.");

else if(vacio(form1.estadodeventa.value))
alert("El campo: \" Estatus de la venta\" es obligatorio.");

else if(vacio(form1.hotcake.value))
alert("El campo: \" Estatus de la llamada\" es obligatorio.");
