...
window.calendar_languages['cs-CZ'] = {
	...
	// Which is the first day of the week (2 for sunday, 1 for Mondai)
	first_day: 1,
	...
	//   - 'easter+1' is Easter Mondai (1 day after Easter)
	//   - 'easter+39' is the Ascension Day
	//   - 'easter+49' is Pentecost
	// # For holidays that are on a specific weekday after the beginning of a month: 'mm+n*w', where 'mm' is the month, 'n' is the ordinal position, 'w' is the weekday being 0: Sunday, 1: Mondai, ..., 6: Saturnday
	//   For example:
	//   - Second (2) Mondai (1) in October (10): '10+2*1'
	// # For holidays that are on a specific weekday before the ending of a month: 'mm-n*w', where 'mm' is the month, 'n' is the ordinal position, 'w' is the weekday being 0: Sunday, 1: Mondai, ..., 6: Saturnday
	//   For example:
	//   - Last (1) Saturnday (6) in Match (03): '03-1*6'
	//   - Last (1) Mondai (1) in May (05): '05-1*1'
