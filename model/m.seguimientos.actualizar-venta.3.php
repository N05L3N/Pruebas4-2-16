<?php
			# INICIA ENVIO
				...
				$result_mail = mysql_query("SELECT * FROM ecrm_comentarios_v WHERE id_seguimiento = '$id_seguimiento' ORDER BY id_comentarios_v  DESC limit 1,999");
				...
				/*  */
					...
					$result_asignadoa = mysql_query("SELECT asignadoa FROM contacto WHERE id = '$id_seguimiento' ORDER BY id ASC");
