...
# Noviembre del 2014
  ...
  $sql_fecha_asignaciones_01 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-01' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_01 == 0) {
    ...
    $sql_fecha_asignaciones_02 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-02' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_02 == 0) {
    ...
    $sql_fecha_asignaciones_03 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-03' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_03 == 0) {
    ...
    $sql_fecha_asignaciones_04 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-04' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_04 == 0) {
    ...
    $sql_fecha_asignaciones_05 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-05' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_05 == 0) {
    ...
    $sql_fecha_asignaciones_06 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-06' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_06 == 0) {
    ...
    $sql_fecha_asignaciones_07 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-07' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_08 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-08' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_08 == 0) {
    ...
    $sql_fecha_asignaciones_09 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-09' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_09 == 0) {
    ...
    $sql_fecha_asignaciones_10 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-10' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_10 == 0) {
    ...
    $sql_fecha_asignaciones_11 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-11' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_11 == 0) {
    ...
    $sql_fecha_asignaciones_12 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-12' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_12 == 0) {
    ...
    $sql_fecha_asignaciones_13 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-13' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
  ...
  if ($numero_fecha_asignaciones_13 == 0) {
    ...
    $sql_fecha_asignaciones_14 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-14' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_15 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-15' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_16 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-16' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_17 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-17' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_18 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-18' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_19 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-19' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_20 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-20' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_21 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-21' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_22 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-22' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_23 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-23' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_24 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-24' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_25 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-25' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_26 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-26' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_27 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-27' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_28 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-28' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_29 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-29' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    $sql_fecha_asignaciones_30 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-30' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
    ...
    if ($numero_fecha_asignaciones_30 == 0) {
      ...
      $color_fecha_asignaciones_30 = 'd70098';
        ...
        $sql_fecha_asignaciones_31 = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2014-11-31' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal'AND estadodeventa != 'descartado' ";
...
<td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_00 ?>"><span><a href="#" title="<?= $numero_fecha_asignaciones_01 ?> llamadas programadas para: Nov 28"><font color="#333333"></font></a></span></td>
    ...
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_01 ?>"><span><a href="today?d=01&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_01 ?> llamadas programadas para: Nov 1"><font color="#333333">1</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_02 ?>"><span><a href="today?d=02&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_02 ?> llamadas programadas para: Nov 2"><font color="#333333">2</font></a></span></td>
  </tr>
  <tr>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_03 ?>"><span><a href="today?d=03&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_03 ?> llamadas programadas para: Nov 3"><font color="#333333">3</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_04 ?>"><span><a href="today?d=04&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_04 ?> llamadas programadas para: Nov 4"><font color="#333333">4</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_05 ?>"><span><a href="today?d=05&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_05 ?> llamadas programadas para: Nov 5"><font color="#333333">5</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_06 ?>"><span><a href="today?d=06&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_06 ?> llamadas programadas para: Nov 6"><font color="#333333">6</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_07 ?>"><span><a href="today?d=07&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_07 ?> llamadas programadas para: Nov 7"><font color="#333333">7</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_08 ?>"><span><a href="today?d=08&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_08 ?> llamadas programadas para: Nov 8"><font color="#333333">8</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_09 ?>"><span><a href="today?d=09&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_09 ?> llamadas programadas para: Nov 9"><font color="#333333">9</font></a></span></td>
    
  </tr>
  <tr>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_10 ?>"><span><a href="today?d=10&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_10 ?> llamadas programadas para: Nov 10"><font color="#333333">10</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_11 ?>"><span><a href="today?d=11&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_11 ?> llamadas programadas para: Nov 11"><font color="#333333">11</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_12 ?>"><span><a href="today?d=12&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_12 ?> llamadas programadas para: Nov 12" class="bold"><font color="#333333">12</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_13 ?>"><span><a href="today?d=13&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_13 ?> llamadas programadas para: Nov 13"><font color="#333333">13</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_14 ?>"><span><a href="today?d=14&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_14 ?> llamadas programadas para: Nov 14"><font color="#333333">14</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_15 ?>"><span><a href="today?d=15&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_15 ?> llamadas programadas para: Nov 15"><font color="#333333">15</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_16 ?>"><span><a href="today?d=16&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_16 ?> llamadas programadas para: Nov 16"><font color="#333333">16</font></a></span></td>
    
  </tr>
  <tr>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_17 ?>"><span><a href="today?d=17&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_17 ?> llamadas programadas para: Nov 17"><font color="#333333">17</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_18 ?>"><span><a href="today?d=18&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_18 ?> llamadas programadas para: Nov 18"><font color="#333333">18</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_19 ?>"><span><a href="today?d=19&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_19 ?> llamadas programadas para: Nov 19"><font color="#333333">19</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_20 ?>"><span><a href="today?d=20&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_20 ?> llamadas programadas para: Nov 20"><font color="#333333">20</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_21 ?>"><span><a href="today?d=21&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_21 ?> llamadas programadas para: Nov 21"><font color="#333333">21</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_22 ?>"><span><a href="today?d=22&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_22 ?> llamadas programadas para: Nov 22"><font color="#333333">22</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_23 ?>"><span><a href="today?d=23&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_23 ?> llamadas programadas para: Nov 23"><font color="#333333">23</font></a></span></td>
    
  </tr>
  <tr>
      <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_24 ?>"><span><a href="today?d=24&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_24 ?> llamadas programadas para: Nov 24"><font color="#333333">24</font></a></span></td>
      <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_25 ?>"><span><a href="today?d=25&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_25 ?> llamadas programadas para: Nov 25"><font color="#333333">25</font></a></span></td>
      <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_26 ?>"><span><a href="today?d=26&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_26 ?> llamadas programadas para: Nov 26"><font color="#333333">26</font></a></span></td>
      <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_27 ?>"><span><a href="today?d=27&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_27 ?> llamadas programadas para: Nov 27"><font color="#333333">27</font></a></span></td>
      <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_28 ?>"><span><a href="today?d=28&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_28 ?> llamadas programadas para: Nov 28"><font color="#333333">28</font></a></span></td>
      <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_29 ?>"><span><a href="today?d=29&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_29 ?> llamadas programadas para: Nov 29"><font color="#333333">29</font></a></span></td>
      <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_30 ?>"><span><a href="today?d=30&m=11&y=2014" target="_top" title="<?= $numero_fecha_asignaciones_30 ?> llamadas programadas para: Nov 30"><font color="#333333">30</font></a></span></td>
