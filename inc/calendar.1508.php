...
# Marzo del 2015
  ...
  $sql_fecha_asignaciones_01 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-01' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
  ...
  if ($numero_fecha_asignaciones_01 == 0) {
    ...
    $sql_fecha_asignaciones_02 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-02' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
  ...
  if ($numero_fecha_asignaciones_02 == 0) {
    ...
    $sql_fecha_asignaciones_03 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-03' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
  ...
  if ($numero_fecha_asignaciones_03 == 0) {
    ...
    $sql_fecha_asignaciones_04 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-04' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
  ...
  if ($numero_fecha_asignaciones_04 == 0) {
    ...
    $sql_fecha_asignaciones_05 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-05' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
  ...
  if ($numero_fecha_asignaciones_05 == 0) {
    ...
    $sql_fecha_asignaciones_06 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-06' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
  ...
  if ($numero_fecha_asignaciones_06 == 0) {
    ...
    $sql_fecha_asignaciones_07 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-07' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
    ...
    $sql_fecha_asignaciones_08 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-08' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
  ...
  if ($numero_fecha_asignaciones_08 == 0) {
    ...
    $sql_fecha_asignaciones_09 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-09' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
  ...
  if ($numero_fecha_asignaciones_09 == 0) {
    ...
    $sql_fecha_asignaciones_10 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-10' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
  ...
  if ($numero_fecha_asignaciones_10 == 0) {
    ...
    $sql_fecha_asignaciones_11 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-11' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
  ...
  if ($numero_fecha_asignaciones_11 == 0) {
    ...
    $sql_fecha_asignaciones_12 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-12' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
  ...
  if ($numero_fecha_asignaciones_12 == 0) {
    ...
    $sql_fecha_asignaciones_13 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-13' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
  ...
  if ($numero_fecha_asignaciones_13 == 0) {
    ...
    $sql_fecha_asignaciones_14 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-14' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
    ...
    $sql_fecha_asignaciones_15 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-15' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
    ...
    $sql_fecha_asignaciones_16 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-16' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
    ...
    $sql_fecha_asignaciones_17 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-17' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
    ...
    $sql_fecha_asignaciones_18 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-18' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
    ...
    $sql_fecha_asignaciones_19 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-19' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
    ...
    $sql_fecha_asignaciones_20 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-20' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
    ...
    $sql_fecha_asignaciones_21 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-21' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
    ...
    $sql_fecha_asignaciones_22 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-22' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
    ...
    $sql_fecha_asignaciones_23 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-23' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
    ...
    $sql_fecha_asignaciones_24 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-24' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
    ...
    $sql_fecha_asignaciones_25 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-25' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
    ...
    $sql_fecha_asignaciones_26 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-26' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
    ...
    $sql_fecha_asignaciones_27 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-27' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
    ...
    $sql_fecha_asignaciones_28 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-28' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
    ...
    $sql_fecha_asignaciones_29 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-29' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
    ...
    $sql_fecha_asignaciones_30 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-30' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
    ...
    if ($numero_fecha_asignaciones_30 == 0) {
      ...
      $color_fecha_asignaciones_30 = $color_10;
        ...
        $sql_fecha_asignaciones_31 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2015-08-31' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
