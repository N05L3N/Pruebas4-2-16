...
<iframe src="seguimientos.actualizar-venta2.php?id=<?= $id ?>&fechaasignaciones=<?= $fechaasignaciones ?>&fechaproxima=<?= $fechaproxima ?>&estadodeventa=<?= $estadodeventa ?>" width="100%;" height="550" frameborder="no" scrolling="no"></iframe>
