...
<?php
	...
	else if ($id_view == 'asignaciones' OR $id_view == 'diary' OR $id_view == 'late' OR $id_view == 'today' OR $id_view == 'iframe-facturado') {
	...
	else if ($id_view == 'history' OR $id_view == 'info') {
