...
$sql_asignacionesHoy = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '$fecha_asignacionesHoy' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
$result_asignacionesHoy = mysql_query($sql_asignacionesHoy);
$numero_asignacionesHoy = mysql_num_rows($result_asignacionesHoy);

# Mayo del 2016

$color_fecha_asignaciones_00 = 'f5f5f5';

$sql_fecha_asignaciones_01 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-01' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_01 == 0) {
  $color_fecha_asignaciones_01 = 'f5f5f5';
}
  ...
  $sql_fecha_asignaciones_02 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-02' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_02 == 0) {
  $color_fecha_asignaciones_02 = 'f5f5f5';
}
  ...
  $sql_fecha_asignaciones_03 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-03' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_03 == 0) {
  $color_fecha_asignaciones_03 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_04 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-04' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_04 == 0) {
  $color_fecha_asignaciones_04 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_05 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-05' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_05 == 0) {
  $color_fecha_asignaciones_05 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_06 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-06' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_06 == 0) {
  $color_fecha_asignaciones_06 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_07 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-07' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_07 == 0) {
  $color_fecha_asignaciones_07 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_08 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-08' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_08 == 0) {
  $color_fecha_asignaciones_08 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_09 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-09' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_09 == 0) {
  $color_fecha_asignaciones_09 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_10 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-10' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_10 == 0) {
  $color_fecha_asignaciones_10 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_11 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-11' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_11 == 0) {
  $color_fecha_asignaciones_11 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_12 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-12' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_12 == 0) {
  $color_fecha_asignaciones_12 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_13 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-13' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_13 == 0) {
  $color_fecha_asignaciones_13 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_14 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-14' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_14 == 0) {
  $color_fecha_asignaciones_14 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_15 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-15' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_15 == 0) {
  $color_fecha_asignaciones_15 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_16 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-16' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_16 == 0) {
  $color_fecha_asignaciones_16 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_17 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-17' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_17 == 0) {
  $color_fecha_asignaciones_17 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_18 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-18' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_18 == 0) {
  $color_fecha_asignaciones_18 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_19 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-19' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_19 == 0) {
  $color_fecha_asignaciones_19 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_20 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-20' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_20 == 0) {
  $color_fecha_asignaciones_20 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_21 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-21' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_21 == 0) {
  $color_fecha_asignaciones_21 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_22 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-22' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_22 == 0) {
  $color_fecha_asignaciones_22 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_23 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-23' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_23 == 0) {
  $color_fecha_asignaciones_23 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_24 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-24' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_24 == 0) {
  $color_fecha_asignaciones_24 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_25 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-25' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_25 == 0) {
  $color_fecha_asignaciones_25 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_26 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-26' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_26 == 0) {
  $color_fecha_asignaciones_26 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_27 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-27' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_27 == 0) {
  $color_fecha_asignaciones_27 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_28 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-28' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_28 == 0) {
  $color_fecha_asignaciones_28 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_29 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-29' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_29 == 0) {
  $color_fecha_asignaciones_29 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_30 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-30' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_30 == 0) {
  $color_fecha_asignaciones_30 = 'f5f5f5';
}
...
$sql_fecha_asignaciones_31 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-05-31' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_31 == 0) {
  $color_fecha_asignaciones_31 = 'f5f5f5';
}
...
<table width="100%" cellspacing="0" cellpadding="0" class="calendar">
	<tr>
		<td colspan="7" class="calcell" style="text-align:left;color:#999999">Mayo 2016</td>
	</tr>
	<tr>
	...
	<tr>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_00 ?>"><span><a href="#" title="<?= $numero_fecha_asignaciones_01 ?> llamadas programadas para: Mayo 30"><font color="#333333"></font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_00 ?>"><span><a href="#" title="<?= $numero_fecha_asignaciones_01 ?> llamadas programadas para: Mayo 30"><font color="#333333"></font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_00 ?>"><span><a href="#" title="<?= $numero_fecha_asignaciones_01 ?> llamadas programadas para: Mayo 30"><font color="#333333"></font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_00 ?>"><span><a href="#" title="<?= $numero_fecha_asignaciones_01 ?> llamadas programadas para: Mayo 30"><font color="#333333"></font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_00 ?>"><span><a href="#" title="<?= $numero_fecha_asignaciones_01 ?> llamadas programadas para: Mayo 30"><font color="#333333"></font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_00 ?>"><span><a href="#" title="<?= $numero_fecha_asignaciones_01 ?> llamadas programadas para: Mayo 30"><font color="#333333"></font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_01 ?>"><span><a href="today?d=01&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_01 ?> llamadas programadas para: Mayo 1"><font color="#333333">1</font></a></span></td>
  </tr>
  <tr>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_02 ?>"><span><a href="today?d=02&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_02 ?> llamadas programadas para: Mayo 2"><font color="#333333">2</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_03 ?>"><span><a href="today?d=03&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_03 ?> llamadas programadas para: Mayo 3"><font color="#333333">3</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_04 ?>"><span><a href="today?d=04&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_04 ?> llamadas programadas para: Mayo 4"><font color="#333333">4</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_05 ?>"><span><a href="today?d=05&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_05 ?> llamadas programadas para: Mayo 5"><font color="#333333">5</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_06 ?>"><span><a href="today?d=06&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_06 ?> llamadas programadas para: Mayo 6"><font color="#333333">6</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_07 ?>"><span><a href="today?d=07&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_07 ?> llamadas programadas para: Mayo 7"><font color="#333333">7</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_08 ?>"><span><a href="today?d=08&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_08 ?> llamadas programadas para: Mayo 8"><font color="#333333">8</font></a></span></td>
  </tr>
  <tr>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_09 ?>"><span><a href="today?d=09&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_09 ?> llamadas programadas para: Mayo 9"><font color="#333333">9</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_10 ?>"><span><a href="today?d=10&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_10 ?> llamadas programadas para: Mayo 10"><font color="#333333">10</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_11 ?>"><span><a href="today?d=11&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_11 ?> llamadas programadas para: Mayo 11"><font color="#333333">11</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_12 ?>"><span><a href="today?d=12&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_12 ?> llamadas programadas para: Mayo 12" class="bold"><font color="#333333">12</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_13 ?>"><span><a href="today?d=13&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_13 ?> llamadas programadas para: Mayo 13"><font color="#333333">13</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_14 ?>"><span><a href="today?d=14&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_14 ?> llamadas programadas para: Mayo 14"><font color="#333333">14</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_15 ?>"><span><a href="today?d=15&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_15 ?> llamadas programadas para: Mayo 15"><font color="#333333">15</font></a></span></td>
  </tr>
  <tr>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_16 ?>"><span><a href="today?d=16&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_16 ?> llamadas programadas para: Mayo 16"><font color="#333333">16</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_17 ?>"><span><a href="today?d=17&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_17 ?> llamadas programadas para: Mayo 17"><font color="#333333">17</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_18 ?>"><span><a href="today?d=18&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_18 ?> llamadas programadas para: Mayo 18"><font color="#333333">18</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_19 ?>"><span><a href="today?d=19&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_19 ?> llamadas programadas para: Mayo 19"><font color="#333333">19</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_20 ?>"><span><a href="today?d=20&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_20 ?> llamadas programadas para: Mayo 20"><font color="#333333">20</font></a></span></td> 
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_21 ?>"><span><a href="today?d=21&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_21 ?> llamadas programadas para: Mayo 21"><font color="#333333">21</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_22 ?>"><span><a href="today?d=22&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_22 ?> llamadas programadas para: Mayo 22"><font color="#333333">22</font></a></span></td>
  </tr>
  <tr>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_23 ?>"><span><a href="today?d=23&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_23 ?> llamadas programadas para: Mayo 23"><font color="#333333">23</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_24 ?>"><span><a href="today?d=24&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_24 ?> llamadas programadas para: Mayo 24"><font color="#333333">24</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_25 ?>"><span><a href="today?d=25&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_25 ?> llamadas programadas para: Mayo 25"><font color="#333333">25</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_26 ?>"><span><a href="today?d=26&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_26 ?> llamadas programadas para: Mayo 26"><font color="#333333">26</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_27 ?>"><span><a href="today?d=27&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_27 ?> llamadas programadas para: Mayo 27"><font color="#333333">27</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_28 ?>"><span><a href="today?d=28&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_28 ?> llamadas programadas para: Mayo 28"><font color="#333333">28</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_29 ?>"><span><a href="today?d=29&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_29 ?> llamadas programadas para: Mayo 29"><font color="#333333">29</font></a></span></td>
  </tr>

  <tr>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_30 ?>"><span><a href="today?d=30&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_30 ?> llamadas programadas para: Mayo 30"><font color="#333333">30</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_31 ?>"><span><a href="today?d=31&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_31 ?> llamadas programadas para: Mayo 31"><font color="#333333">31</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_00 ?>"><span><a href="#" title="<?= $numero_fecha_asignaciones_01 ?> llamadas programadas para: Mayo 30"><font color="#333333"></font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_00 ?>"><span><a href="#" title="<?= $numero_fecha_asignaciones_01 ?> llamadas programadas para: Mayo 30"><font color="#333333"></font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_00 ?>"><span><a href="#" title="<?= $numero_fecha_asignaciones_01 ?> llamadas programadas para: Mayo 30"><font color="#333333"></font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_00 ?>"><span><a href="#" title="<?= $numero_fecha_asignaciones_01 ?> llamadas programadas para: Mayo 30"><font color="#333333"></font></a></span></td>
...
if ($lock_calendarInfo == '1') {  } else { include('calendar-info.php'); }
