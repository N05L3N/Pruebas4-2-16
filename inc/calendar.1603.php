...
$sql_fecha_asignaciones_01 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-01' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_01 == 0) {
  ...
  $sql_fecha_asignaciones_02 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-02' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
if ($numero_fecha_asignaciones_02 == 0) {
  ...
  $sql_fecha_asignaciones_03 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-03' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_04 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-04' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_05 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-05' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_06 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-06' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_07 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-07' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_08 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-08' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_09 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-09' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_10 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-10' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_11 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-11' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_12 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-12' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_13 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-13' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_14 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-14' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_15 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-15' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_16 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-16' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_17 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-17' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_18 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-18' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_19 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-19' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_20 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-20' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_21 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-21' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_22 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-22' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_23 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-23' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_24 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-24' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_25 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-25' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_26 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-26' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_27 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-27' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_28 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-28' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_29 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-29' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_30 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-30' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
$sql_fecha_asignaciones_31 = "SELECT DISTINCT(id_seguimiento) FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '2016-03-31' AND horaasignacion != 'ok' AND estadodeventa != 'descartado'";
...
<table width="100%" cellspacing="0" cellpadding="0" class="calendar">
	<tr>
		<td colspan="7" class="calcell" style="text-align:left;color:#999999">Marzo 2016</td>
	</tr>
	<tr>
    ...
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_01 ?>"><span><a href="today?d=01&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_01 ?> llamadas programadas para: Mar 1"><font color="#333333">1</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_02 ?>"><span><a href="today?d=02&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_02 ?> llamadas programadas para: Mar 2"><font color="#333333">2</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_03 ?>"><span><a href="today?d=03&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_03 ?> llamadas programadas para: Mar 3"><font color="#333333">3</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_04 ?>"><span><a href="today?d=04&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_04 ?> llamadas programadas para: Mar 4"><font color="#333333">4</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_05 ?>"><span><a href="today?d=05&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_05 ?> llamadas programadas para: Mar 5"><font color="#333333">5</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_06 ?>"><span><a href="today?d=06&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_06 ?> llamadas programadas para: Mar 6"><font color="#333333">6</font></a></span></td>
  </tr>
  <tr>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_07 ?>"><span><a href="today?d=07&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_07 ?> llamadas programadas para: Mar 7"><font color="#333333">7</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_08 ?>"><span><a href="today?d=08&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_08 ?> llamadas programadas para: Mar 8"><font color="#333333">8</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_09 ?>"><span><a href="today?d=09&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_09 ?> llamadas programadas para: Mar 9"><font color="#333333">9</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_10 ?>"><span><a href="today?d=10&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_10 ?> llamadas programadas para: Mar 10"><font color="#333333">10</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_11 ?>"><span><a href="today?d=11&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_11 ?> llamadas programadas para: Mar 11"><font color="#333333">11</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_12 ?>"><span><a href="today?d=12&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_12 ?> llamadas programadas para: Mar 12" class="bold"><font color="#333333">12</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_13 ?>"><span><a href="today?d=13&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_13 ?> llamadas programadas para: Mar 13"><font color="#333333">13</font></a></span></td>
  </tr>
  <tr>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_14 ?>"><span><a href="today?d=14&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_14 ?> llamadas programadas para: Mar 14"><font color="#333333">14</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_15 ?>"><span><a href="today?d=15&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_15 ?> llamadas programadas para: Mar 15"><font color="#333333">15</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_16 ?>"><span><a href="today?d=16&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_16 ?> llamadas programadas para: Mar 16"><font color="#333333">16</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_17 ?>"><span><a href="today?d=17&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_17 ?> llamadas programadas para: Mar 17"><font color="#333333">17</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_18 ?>"><span><a href="today?d=18&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_18 ?> llamadas programadas para: Mar 18"><font color="#333333">18</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_19 ?>"><span><a href="today?d=19&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_19 ?> llamadas programadas para: Mar 19"><font color="#333333">19</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_20 ?>"><span><a href="today?d=20&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_20 ?> llamadas programadas para: Mar 20"><font color="#333333">20</font></a></span></td> 
  </tr>
  <tr>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_21 ?>"><span><a href="today?d=21&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_21 ?> llamadas programadas para: Mar 21"><font color="#333333">21</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_22 ?>"><span><a href="today?d=22&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_22 ?> llamadas programadas para: Mar 22"><font color="#333333">22</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_23 ?>"><span><a href="today?d=23&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_23 ?> llamadas programadas para: Mar 23"><font color="#333333">23</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_24 ?>"><span><a href="today?d=24&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_24 ?> llamadas programadas para: Mar 24"><font color="#333333">24</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_25 ?>"><span><a href="today?d=25&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_25 ?> llamadas programadas para: Mar 25"><font color="#333333">25</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_26 ?>"><span><a href="today?d=26&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_26 ?> llamadas programadas para: Mar 26"><font color="#333333">26</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_27 ?>"><span><a href="today?d=27&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_27 ?> llamadas programadas para: Mar 27"><font color="#333333">27</font></a></span></td>
  </tr>
  <tr>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_28 ?>"><span><a href="today?d=28&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_28 ?> llamadas programadas para: Mar 28"><font color="#333333">28</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_29 ?>"><span><a href="today?d=29&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_29 ?> llamadas programadas para: Mar 29"><font color="#333333">29</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_30 ?>"><span><a href="today?d=30&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_30 ?> llamadas programadas para: Mar 30"><font color="#333333">30</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_31 ?>"><span><a href="today?d=31&m=01&y=2016" target="_top" title="<?= $numero_fecha_asignaciones_31 ?> llamadas programadas para: Mar 31"><font color="#333333">31</font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_00 ?>"><span><a href="#" title="<?= $numero_fecha_asignaciones_01 ?> llamadas programadas para: Mar 30"><font color="#333333"></font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_00 ?>"><span><a href="#" title="<?= $numero_fecha_asignaciones_01 ?> llamadas programadas para: Mar 30"><font color="#333333"></font></a></span></td>
    <td class="calcell" style="text-align:center" width="14%" bgcolor="<?= $color_fecha_asignaciones_00 ?>"><span><a href="#" title="<?= $numero_fecha_asignaciones_01 ?> llamadas programadas para: Mar 30"><font color="#333333"></font></a></span></td>
  </tr>
