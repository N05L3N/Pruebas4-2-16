        ...
        if ($_GET['dev'] == '1') {
            ...
            if ($filterDate1US == '--' OR $filterDate2US == '--' OR $filterDate1US == '' OR $filterDate2US == '') {
                ...
                $whereDateRecords2 = "fecha > '2010-12-10'";
                    ...
                    $whereDateRecords2 = "fecha >= '$filterDate1US' AND fecha <= '$filterDate2US'";
            ...
            # echo '<pre> SELECT * FROM ecrm_comentarios_v WHERE (usuario = \'sdelacruz\' OR usuario = \'ccastillo\' OR usuario = \'dfernandez\' OR usuario =\'aaranza\') AND ' . $whereDateRecords . ' ORDER BY usuario ASC LIMIT 0,9999</pre>';
