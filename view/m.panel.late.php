...
<?php
  ...
  $result = mysql_query("SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima > '$fecha_actual' ORDER BY id_comentarios_v desc limit $start,$per_page");
