	...
	<div class="col-md-4">
		...
		<div class="row">
			<div class="col-md-3">
				...
				<a href="seguimientos.actualizar-venta4.php?id=<?= $id ?>&vendedor=<?= $_GET['vendedor'] ?>&lateral=iframe-cliente" target="primero">
			...
			<div class="col-md-3">
				...
				<a href="seguimientos.actualizar-venta4.php?id=<?= $id ?>&vendedor=<?= $_GET['vendedor'] ?>&lateral=iframe-calendario" target="primero">
					<button type="button" class="btn btn-default btn-sm" style="width:130px;">
			...
			<div class="col-md-3">
				...
				<a href="seguimientos.actualizar-venta4.php?id=<?= $id ?>&vendedor=<?= $_GET['vendedor'] ?>&lateral=iframe-historial" target="primero">
					<button type="button" class="btn btn-default btn-sm" style="width:130px;">
...
?>
			...
			<div class="col-md-3">
				<!--<a href="iframe-historial.php?id=<?= $id ?>" target="primero">-->
				<a href="seguimientos.actualizar-venta4.php?id=<?= $id ?>&vendedor=<?= $_GET['vendedor'] ?>&lateral=iframe-facturado" target="primero">
					<button type="button" class="btn btn-default btn-sm" style="width:130px;">
					 	<span class="glyphicon glyphicon-star" aria-hidden="true"></span> Facturado
					</button>
				</a>
			</div>
...
<div class="row">
	...
	<div class="col-lg-11">
		<iframe src="seguimientos.actualizar-venta4.php?id=<?= $id ?>&vendedor=<?= $_GET['vendedor'] ?>" name="primero" width="100%;" height="600" frameborder="no" scrolling="no"></iframe>
	</div>
</div>