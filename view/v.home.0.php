<?php
	...
	$sql_pendientes = "SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima < '$fecha_pendientes' AND horaasignacion != 'ok' AND horaasignacion != 'oktemporal' ";
