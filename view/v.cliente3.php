...
<div class="row">
	...
	<div class="col-md-4">
		...
		<div class="row">
			<div class="col-md-4">
				<a href="iframe-cliente.php?id=<?= $id ?>&vendedor=<?= $asignadoa ?>" target="primero">
			...
			<div class="col-md-4">
				<a href="iframe-calendario.php?id=<?= $id ?>&vendedor=<?= $asignadoa ?>" target="primero">
					<button type="button" class="btn btn-default btn-sm" style="width:130px;">
			...
			<div class="col-md-4">
				<a href="iframe-historial.php?id=<?= $id ?>&vendedor=<?= $asignadoa ?>" target="primero">
					<button type="button" class="btn btn-default btn-sm" style="width:130px;">
...
<div class="row">
	...
	<div class="col-lg-11">
		...
		<div class="row">
			<div class="col-md-5">
				<iframe src="iframe-cliente-vista.php?id=<?= $id ?>&vendedor=<?= $asignadoa ?>" width="100%;" height="600" frameborder="no" overflow-y="scroll" overflow-x="hidden" name="primero"></iframe>
			</div>
			<div class="col-md-7">		
				<iframe src="seguimientos.actualizar-venta2.php?id=<?= $id ?>&fechaasignacion=<?= $fechaasignacion ?>&vendedor=<?= $asignadoa ?>" width="100%;" height="600" frameborder="no" scrolling="no"></iframe>
			</div>
		</div>
