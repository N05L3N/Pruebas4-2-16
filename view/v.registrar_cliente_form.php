...
<table width="100%" cellpadding="2">
    <tbody><tr>
        <td style="width:18%;"><b>Nombre Completo:</b> </td>
        <td style="width:30%;"><input type="text" name="nombre" class="form-control" placeholder="Nombre Completo" value=""></td>
        <td style="width:4%;"></td>
        <td style="width:18%;"><b>E-mail:</b></td>
        <td style="width:30%;"><input type="text" name="email" class="form-control" placeholder="Email" value=""></td>
    </tr>
    <tr>
        <td><b>Télefono:</b></td>
        <td><input type="text" name="telefono" class="form-control" placeholder="Telefono" value=""></td>
        <td></td>
        <td><b>Celular:</b></td>
        <td><input type="text" name="nombre_recomendador" class="form-control" placeholder="Celular" value=""></td>
    </tr>
    <tr>
        <td class="temporal"><b>Profesión:</b></td>
        <td><input type="text" name="contacto2" class="form-control" placeholder="Profesión" value=""></td>
        <td></td>
        <td class="temporal"><b>Detalle Especialidad:</b></td>
        <td><input type="text" name="contacto3" class="form-control" placeholder="Detalle Especialidad" value=""></td>
    </tr>
    <tr>
        <td class="temporal"><b>Direccion:</b></td>
        <td><input type="text" name="direccion" class="form-control" placeholder="Direccion" value=""></td>
        <td></td>
        <td class="temporal"><b>Ciudad:</b></td>
        <td><input type="text" name="ciudad" class="form-control" placeholder="Ciudad" value=""></td>
    </tr>
    <tr>
        <td><b>Pais:</b></td>
        <td>
...
<optgroup label="Internet">
    ...
    <tr>
        ...
        <td><input type="text" name="comeqenatp" class="form-control" placeholder="Página web del cliente" value=""></td>
        <td></td>
        <td class="temporal"><b>Puesto:</b></td>
        <td><input type="text" name="eqclosqcuenta" class="form-control" placeholder="Puesto" value=""></td>
    </tr>
    <tr>
        <td class="temporal"><b>Motivo de consulta:</b></td>
        <td><input type="text" name="motivodeconsulta" class="form-control" placeholder="Motivo de consulta" value=""></td>
        <td></td>
        <td class="temporal"><b>Empresa</b></td>
        <td><input type="text" name="empresa" class="form-control" placeholder="Empresa" value=""></td>
    </tr>
    <tr>
    ...
    <optgroup label="----------------------------">
                ...
                <option value="InteriCAD 8000">InteriCAD 8000</option>
                <optgroup label="----------------------------">
...
<table width="100%">
    <tbody><tr>
        <td colspan="2">
            <b>Comentario:</b> <br>
            <textarea name="comentarios" class="form-control" rows="6" style="width:100%; height:100px; resize:none;"></textarea>
        </td>
    </tr>
</tbody></table>
